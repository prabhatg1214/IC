...
function ic_async_beacon(site, paid) {
	...
	currentPg.shift();
	currentPg.shift();
	document.write('<'+'iframe src="http://cdn.investingchannel.com/ga_track.html?s='+site+'&pg='+currentPg.join('/')+'" name="ic_ga_track" width="1" height="1" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" scrolling="no" style="display:none;" ></iframe>');
